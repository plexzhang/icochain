...
// icochain: 挖矿和铸币接口
extern json_spirit::Value setmining(const json_spirit::Array& params, bool fHelp);
...
extern json_spirit::Value getasset(const json_spirit::Array& params, bool fHelp);
